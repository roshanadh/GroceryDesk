...
public class AdminNavigation extends JFrame implements ActionListener
{
	...
	/* For Content Pane */
	Container frameContentPane, addDialogContentPane,updateDialogContentPane;

	/* For Layout */
	SpringLayout frameLayout, addDialogLayout,updateDialogLayout;
	...
	/* For Buttons */
	JButton logoutMenuButton,addStorekeepersButton, viewStorekeepersButton, storekeeperPanelButton, registerDialogButton, cancelDialogButton, confirmLogoutButton, cancelLogoutButton,confirmUpdateButton,cancelUpdateButton;
