...
public class AdminNavigation extends JFrame implements ActionListener
{
	...
	/* For Content Pane */
	Container aboutProjectDialogContentPane,frameContentPane, addDialogContentPane,updateDialogContentPane;

	/* For Layout */
	SpringLayout aboutProjectDialogLayout,frameLayout, addDialogLayout,updateDialogLayout;
	...
	/* For JDialog */
	JDialog aboutProjectDialog,addStorekeeperDialog,updateProfileDialog, confirmLogoutDialog;

	/* For Buttons */
	JButton aboutProjectDialogCloseButton,logoutMenuButton,addStorekeepersButton, viewStorekeepersButton, storekeeperPanelButton, registerDialogButton, cancelDialogButton, confirmLogoutButton, cancelLogoutButton,confirmUpdateButton,cancelUpdateButton;

	/* For Labels */
	JLabel adminWelcomeLabel, idAddNewLabel, passwordAddNewLabel, confirmPasswordLabel, fnameAddNewLabel, lnameAddNewLabel, addressAddNewLabel, phoneAddNewLabel, passIncorrectMsg,updatePassIncorrectMsg, confirmLogoutMessage,updateIDLabel,updatePasswordLabel,updateConfirmPasswordLabel,updateFnameLabel,updateLnameLabel;

	/* For JTextFields */
	JPasswordField passwordAddNewField, confirmPasswordField,updatePasswordField,updateConfirmPasswordField;
	JTextField idAddNewTextField, fnameAddNewTextField, lnameAddNewTextField, addressAddNewTextField, phoneAddNewTextField,updateIDTextField,updateFnameTextField,updateLnameTextField;
...
//		adminWelcomeLabel.setText("Welcome, " + loginID + "!");
		...
		updateProfileDialog.getContentPane().setBackground(new Color(44, 62, 80));
