...
public class AdminNavigation extends JFrame implements ActionListener
{
	...
	/* For JDialog */
	JDialog addStorekeeperDialog, confirmLogoutDialog;
	...
	public AdminNavigation()
	{
		...
		confirmLogoutDialog = new JDialog();
	...
	public void startSystem(String loginID)
	{
		...
		dialogContentPane = addStorekeeperDialog.getContentPane();
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		if (sourceButton == registerDialogButton)
		{
			try
			{
				String storekeeperID = idAddNewTextField.getText(), storekeeperFname = fnameAddNewTextField.getText(), storekeeperLname = lnameAddNewTextField.getText(), storekeeperAddress = addressAddNewTextField.getText(), customerPhone = phoneAddNewTextField.getText();
				...
				query = "INSERT INTO storekeeper(id,password,fname,lname,address,phone,added_in,added_by) VALUES('" + storekeeperID + "','" + storekeeperPassword + "','" + storekeeperFname + "','" + storekeeperLname + "','" + storekeeperAddress + "','" + customerPhone + "','" + dateTimeStamp + "','" + loginID + "');";
			...
			{
				JOptionPane.showMessageDialog(this, "Storekeeper ID already exists!", "GroceryDesk- Error!", JOptionPane.ERROR_MESSAGE);
			} catch (SQLException e)
			{
				e.printStackTrace();
