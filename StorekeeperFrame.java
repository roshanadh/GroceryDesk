...
public class StorekeeperFrame extends JFrame implements ActionListener, DocumentListener, ItemListener
{
	...
	public StorekeeperFrame(String databaseID, String databasePassword)
	{
		...
		{
			e.printStackTrace();
			JOptionPane.showMessageDialog(this,e.getErrorCode()+" Connection to database couldn't be established!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
		}
...
//			inventoryTable.setModel(inventoryTableModel);
		...
		{
			e.printStackTrace();
			JOptionPane.showMessageDialog(this,e.getErrorCode()+" Data couldn't be retrieved from the database!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		try
		{
			...
			if (sourceButton == processTransactionButton)
			{
				...
				int parsedQuantity=Integer.parseInt(quantityTextField.getText());
									...
									if (saleRadioButton.isSelected())
									{
										if (quantityFromTable >= quantity)
										{
											...
											else
											{
												...
												{
													e.printStackTrace();
													JOptionPane.showMessageDialog(this,e.getErrorCode()+" Database Error Occurred!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
												}
											}
...
//										JOptionPane.showMessageDialog(this, "Database couldn't be updated!", "GroceryDesk- Error!", JOptionPane.ERROR_MESSAGE);
							...
							} else
							{
								...
								} else if (debitRadioButton.isSelected())
								{
									...
									else
									{
										...
										if (newAmount == 0)
										{
											JOptionPane.showMessageDialog(this, "Database Updated Successfully! The customer has no credits due!", "GroceryDesk- Success!", JOptionPane.INFORMATION_MESSAGE);
			...
			else if (sourceButton == registerDialogButton)
			{
				...
				else if (phoneAddNewTextField.getText().charAt(0) !='0' && phoneAddNewTextField.getText().charAt(0) !='9')
				{
					...
					{
						JOptionPane.showMessageDialog(this, e.getErrorCode() + " The specified Customer ID is not available!", "GroceryDesk- Error!", JOptionPane.ERROR_MESSAGE);
					} catch (SQLException e)
					{
						e.printStackTrace();
						JOptionPane.showMessageDialog(this, e.getErrorCode() + " Database Error Occurred!", "GroceryDesk- Error!", JOptionPane.ERROR_MESSAGE);
		...
		{
			JOptionPane.showMessageDialog(this,e.getErrorCode()+" The specified Product ID is not available!","GroceryDesk- Error!",JOptionPane.ERROR_MESSAGE);
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	public void showInventoryRowInfo(MouseEvent e)
	{
		...
		{
			exp.printStackTrace();
			JOptionPane.showMessageDialog(this,exp.getErrorCode()+" Database Exception Occurred!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
		}
