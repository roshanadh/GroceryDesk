...
public class StorekeeperTable extends JDialog implements ActionListener
{
	...
	private static int storekeeperSelectedRowNumber;
	private static String selectedCellValue,selectedColumnName;
	...
	/* For Content Pane */
	private Container frameContentPane,rowInfoDialogContentPane;
	...
	/* For Components */
	private JLabel messageLabel,storekeeperAddedInLabel,storekeeperGetAddedInLabel,storekeeperAddedByLabel,storekeeperGetAddedByLabel,storekeeperLastUpdatedInLabel,storekeeperGetLastUpdatedByLabel,storekeeperLastUpdatedByLabel,getStorekeeperGetLastUpdatedByLabel;
	private JTable storekeeperTable;
	private JScrollPane storekeeperTableSp;
	private JDialog storekeeperRowInfoDialog;
	private DefaultTableModel storekeeperTableModel;
