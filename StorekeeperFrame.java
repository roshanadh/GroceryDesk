...
public class StorekeeperFrame extends JFrame implements ActionListener, DocumentListener, ItemListener
{
	...
	/* For Layouts */
	SpringLayout frameLayout,posTabLayout,creditTabLayout,dialogLayout;

	/* For Content Pane */
	Container frameContentPane,dialogContentPane;
	...
	JLabel storekeeperWelcomeLabel,productIDLabel,quantityLabel,posTransactionLabel,creditsDueLabel,posCustomerIDLabel,amountLabel,orLabel,creditCustomerIDLabel,creditTransactionLabel,idAddNewLabel,fnameAddNewLabel,lnameAddNewLabel,addressAddNewLabel,phoneAddNewLabel,confirmLogoutMessage;
	JTextField productIDTextField,quantityTextField,creditsDueTextField,posCustomerIDTextField,creditCustomerIDTextField,amountTextField,idAddNewTextField,fnameAddNewTextField,lnameAddNewTextField,addressAddNewTextField,phoneAddNewTextField;
	JButton processTransactionButton,addNewButton,processCreditsButton,registerDialogButton,cancelDialogButton,confirmLogoutButton,cancelLogoutButton,rowInfoOKButton;
	...
	JDialog addNewDialog,rowInfoDialog,confirmLogoutDialog;
	...
	public void startSystem(String loginID,int index)
	{
		...
		posTabLayout.putConstraint(SpringLayout.EAST,processTransactionButton,-23,SpringLayout.EAST,creditsDueTextField);
		...
		posTabLayout.putConstraint(SpringLayout.EAST,inventoryTableSp,190,SpringLayout.EAST,processTransactionButton);
		posTabLayout.putConstraint(SpringLayout.SOUTH,inventoryTableSp,417,SpringLayout.SOUTH,receiptRadioButton);
	...
	public void showRowInfoDialog()//Component component,String columnName)
	{
