...
public class Storekeeper extends JFrame implements ActionListener, DocumentListener, ItemListener
{
	...
	private String databaseID,databasePassword,posCustomerID,creditCustomerID,inventoryColumnName,inventoryCellValue,creditAccountsColumnName,creditAccountsCellValue;
	private static float creditsDue,amount;
	private static boolean creditsDueFilled=false,customerIDFilled=false,outOfStockError=false,catchPhoneNotNumberException=true,continueDebitProcess=true,debitNoSuccessDialogRequired=false,customerIDNonExistentError=false;
	private static int transactionQuantityRows,transactionAmountRows,inventorySelectedRowNumber,creditAccountsSelectedRowNumber,loginPrivilege;

	/*----------------------------------- Declarations and Prerequisites----------------------------------- */
	/* For JDBC */
	private String databaseURL="jdbc:mysql://localhost?useSSL=true";
	...
	/* Dimension and Fonts */
	private Dimension textFieldDimension,buttonDimension;
	private Font textFieldFont,labelFont,buttonFont;

	/* For Layouts */
	private SpringLayout frameLayout,aboutProjectDialogLayout,posTabLayout,creditTabLayout,dialogLayout,productDialogLayout,rowInfoDialogLayout;

	/* For Content Pane */
	private Container frameContentPane,aboutProjectDialogContentPane,dialogContentPane,productDialogContentPane,rowInfoDialogContentPane;

	/* For Components */
	private JMenuBar mainMenuBar;
	private JMenu aboutMenu,settingsMenu,adminPanelMenu;
	private JMenuItem aboutProjectMenuItem,logoutMenuItem;
	private JTabbedPane storekeeperPanelTab;
	private JPanel storekeeperPanelPos,storekeeperPanelCreditAccounts;
	...
	private JTextField productIDTextField,quantityTextField,creditsDueTextField,posCustomerIDTextField,creditCustomerIDTextField,amountTextField,idAddNewTextField,fnameAddNewTextField,lnameAddNewTextField,addressAddNewTextField,phoneAddNewTextField,creditAmountAddNewTextField,productIDAddNewTextField,productNameAddNewTextField,rateAddNewTextField,quantityAddNewTextField;
	private JButton logoutMenuButton,aboutProjectDialogCloseButton,processTransactionButton,addNewCustomerButton,processCreditsButton,addNewProductButton,confirmNewProductButton,registerDialogButton,cancelDialogButton,confirmLogoutButton,cancelLogoutButton,inventoryCancelButton,inventoryRemoveEntryButton,cancelNewProductButton,creditAccountsRemoveEntryButton,creditAccountsCancelButton;
	private JRadioButton saleRadioButton,receiptRadioButton,creditRadioButton,debitRadioButton;
	private ButtonGroup creditTransactionButtonGroup,posTransactionButtonGroup;
	private JTable inventoryTable,creditAccountsTable;
	private JScrollPane inventoryTableSp,creditAccountsTableSp;
	private JDialog aboutProjectDialog,addNewDialog,inventoryRowInfoDialog,creditAccountsRowInfoDialog,confirmLogoutDialog,addNewProductDialog;
	private JTextPane aboutProjectTextPane;
	private DefaultTableModel inventoryTableModel,creditAccountsTableModel;
	...
	public Storekeeper(String databaseID, String databasePassword)
	{
		...
		registerDialogButton=new JButton("Register Customer");
...
//			mainMenuBar.add(settingsMenu);
		...
		storekeeperWelcomeLabel.setForeground(new Color(34, 49, 63));
		...
		cancelLogoutButton.setBackground(new Color(103, 128, 159));//Color.WHITE);
...
////		});
		...
		processTransactionButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseEntered(MouseEvent e)
			{
				...
				processTransactionButton.setForeground(new Color(34, 49, 63));
			}
			public void mouseExited(MouseEvent e)
			{
				processTransactionButton.setBackground(Color.WHITE);
		...
		processCreditsButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseEntered(MouseEvent e)
			{
				...
				processCreditsButton.setForeground(new Color(34, 49, 63));
			}
			public void mouseExited(MouseEvent e)
			{
				processCreditsButton.setBackground(Color.WHITE);
		...
		addNewCustomerButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseEntered(MouseEvent e)
			{
				...
				addNewCustomerButton.setForeground(new Color(34, 49, 63));
			}
			public void mouseExited(MouseEvent e)
			{
				addNewCustomerButton.setBackground(Color.WHITE);
		...
		addNewProductButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseEntered(MouseEvent e)
			{
				...
				addNewProductButton.setForeground(new Color(34, 49, 63));
			}
			public void mouseExited(MouseEvent e)
			{
				addNewProductButton.setBackground(Color.WHITE);
		...
		addNewDialog.getContentPane().setBackground(new Color(34, 49, 63));
...
//										JOptionPane.showMessageDialog(this, "Database couldn't be updated!", "GroceryDesk- Error!", JOptionPane.ERROR_MESSAGE);
							...
							} else
							{
								...
								if(continueDebitProcess)
								{
									...
									if (rowsAffected > 0)
									{
										...
										String fnameString = null, lnameString = null,FOLDER=null;
										...
										sb.append(',');
										if(creditRadioButton.isSelected())
											sb.append("Credited Amount");
										else if(debitRadioButton.isSelected())
											sb.append("Debited Amount");
										sb.append(',');
			...
			else if(sourceButton==confirmNewProductButton)
			{
				...
				{
					JOptionPane.showMessageDialog(this, "Product Name field cannot be left blank!", "GroceryDesk- Error", JOptionPane.ERROR_MESSAGE);
				} else
				{
					try
					{
