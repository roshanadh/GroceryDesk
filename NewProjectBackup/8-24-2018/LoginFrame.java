...
public class LoginFrame extends JFrame implements ActionListener
{
	...
	/* For JDBC */
	private static String databaseURL="jdbc:mysql://localhost?useSSL=true";
	...
	private Dimension userTextFieldDimension,databaseTextFieldDimension,buttonDimension;
	private Font userLabelFont,databaseLabelFont,buttonFont;

	/* Other declarations */
	private String errorMessage;

	/* For Components */
	private JLabel loginIDLabel,loginPassLabel,databaseUsernameLabel,databasePasswordLabel;
	private JTextField loginIDTextField,databaseUsernameTextField,databasePasswordTextField;
	private JPasswordField loginPassTextField;
	private JButton loginButton;
	private JDialog loginErrorMessageDialog;
	private JLabel loginErrorMessageLabel;
	private JButton loginErrorMessageOKButton;
	...
	public LoginFrame()
	{
		...
		loginButton.addMouseListener(new MouseAdapter()
		{
			...
			public void mouseEntered(MouseEvent e)
			{
				...
				loginButton.setForeground(new Color(34, 49, 63));
			}
