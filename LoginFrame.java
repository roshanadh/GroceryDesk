...
public class LoginFrame extends JFrame implements ActionListener
{
	...
	/* For JDBC */
//	static String databaseURL="jdbc:mysql://localhost/grocerydesk?useSSL=true";
...
//				                            setIconImage(new ImageIcon(getClass().getResource("grocerydeskIcon.png")).getImage());
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		if(sourceButton==loginButton)
		{
			...
			System.out.println("This is loginID: "+loginID);
			if(loginID.equals("") )
			{
...
//				createDBSchema();
	...
	public void createDBSchema()
	{
		...
		{
			e.printStackTrace();
			JOptionPane.showMessageDialog(this,e.getErrorCode(),"GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
			JOptionPane.showMessageDialog(this,"Could not create required schemas!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
		}
		finally
		{
