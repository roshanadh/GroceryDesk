...
public class LoginFrame extends JFrame implements ActionListener
{
	...
	public void createDBSchema()
	{
		...
		{
			e.printStackTrace();
			JOptionPane.showMessageDialog(this,e.getErrorCode()+" Could not create required schemas! Try restarting the application!","GroceryDesk- Error",JOptionPane.ERROR_MESSAGE);
		}
		finally
		{
